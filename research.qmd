...
The Leifeld Lab develops **statistical methods and research infrastructure for identifying, estimating, and examining theoretically meaningful mechanisms in dynamic relational data** arising from social, political, or economic processes. Our work focuses on settings where time, dependence, and measurement interact to produce complex data.
...
Relational event representations are used where appropriate as a means of preserving theoretically relevant interaction histories.

Example output: {{< bi file-earmark-text >}} [JRSSA, forthcoming](https://doi.org/10.1093/jrsssa/qnag069)
...
Example output: {{< bi file-earmark-text >}} [CSDA 2026](https://doi.org/10.1016/j.csda.2026.108428)
...
Textual material is treated as **measurement infrastructure**: a vehicle for constructing relational data, not an object of inference in its own right.

Example output: {{< bi file-earmark-text >}} [JCMS, forthcoming](https://doi.org/10.1111/jcms.70119)
...
- delineating the limits and assumptions of statistical models for network data using simulations and applications;
...
Example output: {{< bi file-earmark-text >}} [Social Networks 2024](https://doi.org/10.1016/j.socnet.2023.11.004)
